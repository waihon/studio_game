#####
# Pragmatic Stuio Ruby Programming
# 22 - Distribution
# This version has changes:
# 1. Embed Treasure describe within Games module.
# 2. Change path of require_relative to './../../lib/games/treasure_trove.
#####

require_relative './../../lib/games/treasure_trove'
...
module Games
  ...
  describe TreasureTrove do
    ...
    it "has a bromstick worth 200 points" do
