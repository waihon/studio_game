...
# 1. Update "it has a string representation".
# 2. Replace "computes a score as the sum of its health and length of name"
#    with "computes a score as the sume of its health and points".
# 3. Add "computes points as the sum of all treasure points".
#####
